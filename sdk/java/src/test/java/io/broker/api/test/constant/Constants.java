...
public class Constants {
    ...
    // FIXME: please change to your valid api domain for test, for example: xcex.io
    public static final String BASE_DOMAIN = "";

    // REST api url format: https://api.BASE_DOMAIN
    // for example: https://api.xcex.io
    ...
    // for example: wss://wsapi.xcex.io/openapi/quote/ws/v1
    ...
    // for example: wss://wsapi.xcex.io/openapi/ws
